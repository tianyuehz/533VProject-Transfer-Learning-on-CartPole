...
def main(args):
    ...
    '''Collecting Data with trained UP Policy'''
    # Load trained Policy
    model_path = 'saved_policy_models/UP_k30_ep250_nmu4_full.pth' # Dan model
    ...
    batch = bufB.get()
    #save information
    np.save('save_data/B_buffer_H_full.npy', batch['H']) # save
    np.save('save_data/B_buffer_mu_full.npy', batch['mu']) # save
    
    ''' Training OSI with Data Rollout from UP'''
    # Part 1 data
    ...
    # Part 2 Data
    B_buffer_H = np.load('save_data/B_buffer_H_full.npy'); #print("B_buffer_H", B_buffer_H[0,0])
    B_buffer_mu = np.load('save_data/B_buffer_mu_full.npy'); #print("B_buffer_mu", B_buffer_mu[0,0]);#stop
    ...
    project_dir = "/home/daniel/Documents/Msc/ubc/UBC_Lectures/CPSC_533V/Project/533VProject_modified/"
    file = project_dir + 'save_OSI_models/OSI_dec14.pth'
